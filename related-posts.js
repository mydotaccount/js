<!--RELATED POSTS START-->
<div id="related-posts-container" style="margin-top: 40px;">
...
@media (max-width:768px){
  #related-posts div { width: calc(50% - 10px); margin-bottom:10px; }
}
@media (max-width:480px){
  #related-posts div { width:100%; margin-bottom:10px; }
}
</style>
<!--RELATED POSTS END-->
